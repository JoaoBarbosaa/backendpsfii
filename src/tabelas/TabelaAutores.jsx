...
export default function TabelaAutores(props){
    ...
    function filtrarAlunos(e){
        ...
        const resultadoBusca= props.listaAutores.filter((aluno) => aluno.nome.includes(termoBusca))
        setAutores(resultadoBusca);
    }

    return (
        <Container className="border">
        <h1 className="text-center">Cadastro de Autores</h1>
        <Button onClick={()=>{
