...
export default function TabelaProfessores(props){
    ...
    function excluirProfessor(ra){
        const listaAtualizada = props.listaProfessores.filter((professor) => professor.ra !== ra );
        props.setProfessores(listaAtualizada);
    }

    function filtrarProfessores(e){
        const termoBusca = e.currentTarget.value;
        const resultadoBusca= props.listaProfessores.filter((professor) => professor.nome.includes(termoBusca))
    ...
    return (
        ...
        <Button onClick={()=>{
            ...
            <Form.Control type="text" id="termoBusca" onChange={filtrarProfessores} placeholder="Pesquisar"/>
